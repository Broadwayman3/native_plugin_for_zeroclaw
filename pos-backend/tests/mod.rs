...
pub fn run_suite() -> usize {
    ...
    suites::test_squads_multisig_v2::run_suite();
    suites::test_edge_storage::run_suite();
    suites::test_edge_storage_v2::run_suite();
    ...
    suites::test_zeroclaw_integration_v2::run_suite();
    suites::test_error::run_suite();
    suites::test_config::run_suite();
    suites::test_http_handlers::run_suite();
    suites::test_api_endpoints::run_suite();
    suites::test_pos_flow::run_suite();
    suites::test_rate_limit::run_suite();
    suites::test_auth::run_suite();
